...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-10 text-sm leading-relaxed text-ink dark:text-cream-50">
      <Link href="/" className="text-coral-600 hover:underline">
        ← Back to StayAhead
      </Link>
      <h1 className="mt-4 text-2xl font-bold text-ink dark:text-cream-50">Privacy Policy</h1>
      <p className="mt-1 text-xs text-ink-muted dark:text-ink-300">Last updated August 2026</p>

      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">What we collect</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">No bank connections</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">How your data is stored</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">Email</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">Analytics</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">Deleting your data</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">Children's privacy</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">Changes to this policy</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">Contact</h2>
        <p className="mt-2">
