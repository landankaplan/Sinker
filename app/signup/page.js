...
export default function SignupPage() {
  ...
  if (done) {
    return (
      <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center px-4 text-center">
        <h1 className="mb-2 text-xl font-semibold text-ink dark:text-cream-50">Check your email</h1>
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center px-4">
      <h1 className="mb-1 text-xl font-semibold text-ink dark:text-cream-50">Sign up</h1>
      <p className="mb-6 text-sm text-ink-muted dark:text-ink-300">Start planning for the bills you know are coming.</p>
