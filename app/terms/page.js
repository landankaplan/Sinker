...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-10 text-sm leading-relaxed text-ink dark:text-cream-50">
      ...
      <h1 className="mt-4 text-2xl font-bold text-ink dark:text-cream-50">Terms of Service</h1>
      <p className="mt-1 text-xs text-ink-muted dark:text-ink-300">Last updated August 2026</p>

      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">What StayAhead is</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">Not financial advice</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">Your responsibilities</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">No guarantees</h2>
        <p className="mt-2">
      ...
      <section className="mt-6">
        <h2 className="text-base font-semibold text-ink dark:text-cream-50">Changes</h2>
        <p className="mt-2">
